...
setup(
    ...
    version='0.1.0',
    packages=['he_preprocessing', 'he_preprocessing.utils', 'he_preprocessing.filter', 'he_preprocessing.normalization',
    ...
    install_requires=["PyYAML", "dotmap", "natsort", "numpy", "pandas", "torch", "matplotlib", "tqdm", "opencv-python",
                      "scikit-image", "Pillow", "shapely"] + (
